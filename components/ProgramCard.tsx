...
const ProgramCard: React.FC<ProgramCardProps> = ({ program }) => {
  ...
  return (
    <div
      ...
      className={`group bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6 transition-all duration-300 hover:bg-slate-800 hover:-translate-y-2 hover:shadow-2xl ${program.hoverColor} cursor-pointer flex flex-col`}
    >
      <div className="flex flex-col h-full">
        ...
        {/* This container grows to fill available space and holds the features and button */}
        <div className="flex-grow flex flex-col">
          {/* Features section with transition */}
          <div
            className={`transition-all duration-500 ease-in-out overflow-hidden ${
              // Increased max height and added opacity for a smoother look
          ...
          {/* Button container, pushed to the bottom and right */}
          <div className="mt-auto pt-4 flex justify-end">
            <a
              ...
              className={`inline-flex items-center text-sm font-medium ${program.color} hover:underline`}
            >
              Launch App
              <svg
