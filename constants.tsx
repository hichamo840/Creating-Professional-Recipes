...
export const PROGRAMS: Program[] = [
  ...
  },
  {
    ...
    description: 'Generate stunning, unique images for your recipes.',
    url: 'https://aistudio.google.com/app/apps/drive/16P11j4rjHd2-eOLVTM9l_ZsJjBFiz7I9?showAssistant=true&showPreview=true&resourceKey=',
    icon: ImageIcon,
    color: 'text-blue-400',
    hoverColor: 'hover:shadow-blue-500/10',
    features: [
